...
- [x] Task: Refactor `NodeSelector` to support Accordion layout based on the 4 categories. [8ec5cc0]
- [x] Task: Implement "Manage Nodes" button and a dedicated `NodeManagement` page (Table view of all nodes). [8ec5cc0]
- [x] Task: Update `NodeConfigPanel` to render forms dynamically based on the specific node's Pydantic schema. [8ec5cc0]
