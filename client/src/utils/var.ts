...
const CONTEXT_PLACEHOLDER_TEXT = '{{#context#}}'
const HISTORY_PLACEHOLDER_TEXT = '{{#history#}}'
const PRE_PROMPT_PLACEHOLDER_TEXT = '{{#pre_prompt#}}'
const QUERY_PLACEHOLDER_TEXT = '{{#query#}}'
