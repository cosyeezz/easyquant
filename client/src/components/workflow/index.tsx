...
// Replaced dynamic import with React.lazy
const Confirm = lazy(() => import('@/app/components/base/confirm'))
...
export const Workflow: FC<WorkflowProps> = memo(({
  ...
  return (
    <div
      ...
      className={cn(
        'relative h-full w-full min-w-[960px] bg-workflow-canvas-workflow-bg',
        workflowReadOnly && 'workflow-panel-animation',
        nodeAnimation && 'workflow-node-animation',
        maximizeCanvas && '!fixed !inset-0 !z-[1000] !h-screen !w-screen !min-w-0',
      )}
