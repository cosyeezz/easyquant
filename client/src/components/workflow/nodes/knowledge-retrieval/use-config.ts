...
// Mocks
const useCurrentProviderAndModel = () => ({ currentModel: null, currentProvider: null })
const useModelListAndDefaultModelAndCurrentProviderAndModel = () => ({ currentProvider: null, currentModel: null, modelList: [], defaultModel: null })
